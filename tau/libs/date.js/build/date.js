 ...
 */
define(['./xdate'], function(Date) {

    var KEY = 'www.datejs.com';
    if (Date[KEY]) { return Date; }
    ...
    (function() {
        ...
        var nativeToString = $P.toString;
        var dateToString = function(format) {
            var x = this;
            ...
            }) : nativeToString.apply(this, arguments);
        };
        $P.toString = dateToString;
    }());
    (function() {
