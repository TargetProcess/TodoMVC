...
if (!Object.keys)
	Object.keys = function(obj) {
		...
		var keys = []
		for (var key in obj) if (obj.hasOwnProperty.call(obj, key)) keys[keys.length] = key
		return keys
	}
...
//var id = objecttools.id = Object.defineProperty ? function (object) {
var id = objecttools.id = (1 == 0) ? function (object) {
...
var findRefs = objecttools.findRefs = function (object) {
	...
	var self = function (obj) {
		...
		for (var ks = Object.keys(
            ...
            //if (_.indexOf(specialObjectKeys, key) > -1)
				continue;
