...
module.exports = function () {
    ...
    utils.extend(this.Validation.prototype, {
        ...
        start: function (instance) {
            ...
            instance = this.empty(instance); if (this.wasError() || instance === '' || instance === null) return instance;
        ...
        empty: function (instance) {
            ...
            if (this.schema.empty || (instance !== undefined && instance !== '' && instance !== null)) return instance

            return this.callPlugin(this.schema.fallbacks.optional, instance, 'empty')
        },
        ...
        type: function (instance, type, isFirst) {
            ...
            if (!(toType instanceof Array)) {
                ...
                if (type === 'string') {
                    ...
                    instance = this.minLength(instance);
                    if (this.wasError()) {
                        return instance;
                    }
                ...
                if (instance instanceof Object) {
                    ...
                    instance = this.additionalProperties(instance);
        ...
        "enum": function (instance) {
            ...
            if ('enum' in this.schema) {
                ...
                return _.indexOf(this.schema["enum"], instance) > -1
                    ? instance
        ...
        castTolerantlyToType: function (instance, errorName) {
            ...
            if (toType === 'number') {
                ...
                if (fromType !== 'boolean') {
                    ...
                    if (isNaN(inst) && instance != false) {

                        new this.Error(
                            errorName,
                            env.i18n['validation_error_'+errorName] ? env.i18n['validation_error_'+errorName] : 'validation_error_'+errorName
                        );
                        return instance;
                    }

                    return isNaN(inst) ? instance : inst;
                }
