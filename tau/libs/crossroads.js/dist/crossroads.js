define(['./js-signals'], function () {
    ...
    (function (global) {
        ...
        function typecastValue(val) {
            // TODO: we don't need to cast types in routing
            return val;
            return (val === null) ? val : (
        ...
        crossroads = (function () {
            ...
            function addRoute(pattern, callback, priority) {
                var route = new Route(pattern, callback, priority, api);
                sortedInsert(route);
                return route;
            }
            ...
            function sortedInsert(route) {
                ...
                do {
                    --n;
                } while (_routes[n] && route._priority <= _routes[n]._priority);
        ...
        Route = function (pattern, callback, priority, crossroads) {
            var isRegexPattern = isRegExp(pattern);
            this._crossroads = crossroads;
            ...
            if (callback) this.matched.add(callback, this);
        ...
        Route.prototype = {
            ...
            dispose:function () {
                this._crossroads.removeRoute(this);
            },
        ...
        patternLexer = (function () {
            ...
            function getParamIds(pattern) {
                var ids = [], match;
                var paramsRegExp = new RegExp(PARAMS_REGEXP);
                while (match = paramsRegExp.exec(pattern)) {
                    ids.push(match[1]);
                }
                return ids;
            }
